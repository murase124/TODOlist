...
namespace _022203TODOリスト
{
    public partial class Form1 : Form
    {
        ...
        private void editData()
        {
            ...
            string naiyou = dataGridView1.CurrentRow.Cells[2].Value.ToString();
        ...
        public bool Data_Return(string naiyou, DateTime simekiri, string Data_id)
        {
        ...
        private bool oracle_Value_editing(string sql)
        {
            try
            {
